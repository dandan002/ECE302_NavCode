...
// Timer_v2_80(CaptureAlternatingFall=false, CaptureAlternatingRise=false, CaptureCount=2, CaptureCounterEnabled=false, CaptureInputEnabled=true, CaptureMode=1, CONTROL3=0, ControlRegRemoved=0, CtlModeReplacementString=SyncCtl, CyGetRegReplacementString=CY_GET_REG16, CySetRegReplacementString=CY_SET_REG16, DeviceFamily=PSoC5, EnableMode=0, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, HWCaptureCounterEnabled=false, InterruptOnCapture=true, InterruptOnFIFOFull=false, InterruptOnTC=false, IntOnCapture=1, IntOnFIFOFull=0, IntOnTC=0, NumberOfCaptures=1, param45=1, Period=65535, RegDefReplacementString=reg16, RegSizeReplacementString=uint16, Resolution=16, RstStatusReplacementString=rstSts, RunMode=0, SiliconRevision=0, SoftwareCaptureModeEnabled=false, SoftwareTriggerModeEnabled=false, TriggerInputEnabled=false, TriggerMode=0, UDB16=true, UDB24=false, UDB32=false, UDB8=false, UDBControlReg=true, UsesHWEnable=0, VerilogSectionReplacementString=sT16, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=Timer_v2_80, CY_CONFIG_TITLE=VID_TIMER, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=VID_TIMER, CY_INSTANCE_SHORT_NAME=VID_TIMER, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=80, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=VID_TIMER, )
...
module top ;
	...
	wire [0:0] tmpOE__HE_net;
	wire [0:0] tmpIO_0__HE_net;
	wire [0:0] tmpINTERRUPT_0__HE_net;
	electrical [0:0] tmpSIOVREF__HE_net;
	...
	cy_psoc3_pins_v1_10
		...
		HE
		 (.oe(tmpOE__HE_net),
		  .y({1'b0}),
		  .fb({Net_2752}),
		  .io({tmpIO_0__HE_net[0:0]}),
		  .siovref(tmpSIOVREF__HE_net),
		  .interrupt({tmpINTERRUPT_0__HE_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__HE_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    assign Net_2767 = 1'h0;
    ...
    UART_v2_50_2 UART (
        ...
        .rx_clk(Net_5939),
        .rx_data(Net_5940),
        .rx_interrupt(Net_5941),
        .tx(Net_5942),
        .tx_clk(Net_5943),
        .tx_data(Net_5944),
        .tx_en(Net_5945),
        .tx_interrupt(Net_5946));
	...
	wire [0:0] tmpOE__RAW_VIDEO_net;
	wire [0:0] tmpFB_0__RAW_VIDEO_net;
	wire [0:0] tmpIO_0__RAW_VIDEO_net;
	wire [0:0] tmpINTERRUPT_0__RAW_VIDEO_net;
	electrical [0:0] tmpSIOVREF__RAW_VIDEO_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("015cff70-106b-43ac-bfac-e4d71be7c309"),
		  ...
		  .input_buffer_sel(2'b00))
		RAW_VIDEO
		 (.oe(tmpOE__RAW_VIDEO_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__RAW_VIDEO_net[0:0]}),
		  .analog({Net_1582}),
		  .io({tmpIO_0__RAW_VIDEO_net[0:0]}),
		  .siovref(tmpSIOVREF__RAW_VIDEO_net),
		  .interrupt({tmpINTERRUPT_0__RAW_VIDEO_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__RAW_VIDEO_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__CSYNC_IN_net;
	wire [0:0] tmpIO_0__CSYNC_IN_net;
	wire [0:0] tmpINTERRUPT_0__CSYNC_IN_net;
	electrical [0:0] tmpSIOVREF__CSYNC_IN_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("d8e2bb6a-063c-4e2f-a56e-4211dfd44ea5"),
		  ...
		  .input_buffer_sel(2'b00))
		CSYNC_IN
		 (.oe(tmpOE__CSYNC_IN_net),
		  .y({1'b0}),
		  .fb({Net_5991}),
		  .io({tmpIO_0__CSYNC_IN_net[0:0]}),
		  .siovref(tmpSIOVREF__CSYNC_IN_net),
		  .interrupt({tmpINTERRUPT_0__CSYNC_IN_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__CSYNC_IN_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__VSYNC_IN_net;
	wire [0:0] tmpIO_0__VSYNC_IN_net;
	wire [0:0] tmpINTERRUPT_0__VSYNC_IN_net;
	electrical [0:0] tmpSIOVREF__VSYNC_IN_net;
	...
	assign tmpOE__VSYNC_IN_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    PWM_v3_30_3 SERVO_PWM (
        .capture(1'b0),
        .clock(Net_333),
        .cmp_sel(1'b0),
        .enable(1'b1),
    ...
    GlitchFilter_v2_0 GLITCHFILTER (
        ...
        .q(Net_3980),
        .reset(Net_2127));
    defparam GLITCHFILTER.BypassFilter = 0;
    defparam GLITCHFILTER.GlitchLength = 36;
    defparam GLITCHFILTER.SignalWidth = 1;

    assign Net_2127 = 1'h0;
    ...
    defparam VID_TIMER.DeviceFamily = "PSoC5";
    defparam VID_TIMER.InterruptOnCapture = 1;
	...
	wire [0:0] tmpIO_0__DEBUG_2_net;
	wire [0:0] tmpINTERRUPT_0__DEBUG_2_net;
	electrical [0:0] tmpSIOVREF__DEBUG_2_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("09a23e5d-3c9a-4343-8a9d-a6aae5b9a76e"),
		  ...
		  .input_buffer_sel(2'b00))
		DEBUG_2
		 (.oe(tmpOE__DEBUG_2_net),
		  .y({Net_3791}),
		  .fb({tmpFB_0__DEBUG_2_net[0:0]}),
		  .io({tmpIO_0__DEBUG_2_net[0:0]}),
		  .siovref(tmpSIOVREF__DEBUG_2_net),
		  .interrupt({tmpINTERRUPT_0__DEBUG_2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__DEBUG_2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__DEBUG_VID_IN_3_net;
	wire [0:0] tmpFB_0__DEBUG_VID_IN_3_net;
	wire [0:0] tmpIO_0__DEBUG_VID_IN_3_net;
	wire [0:0] tmpINTERRUPT_0__DEBUG_VID_IN_3_net;
	electrical [0:0] tmpSIOVREF__DEBUG_VID_IN_3_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("24f2714f-f777-40c9-8f25-07b20aaab61e"),
		  ...
		  .input_buffer_sel(2'b00))
		DEBUG_VID_IN_3
		 (.oe(tmpOE__DEBUG_VID_IN_3_net),
		  .y({Net_3980}),
		  .fb({tmpFB_0__DEBUG_VID_IN_3_net[0:0]}),
		  .io({tmpIO_0__DEBUG_VID_IN_3_net[0:0]}),
		  .siovref(tmpSIOVREF__DEBUG_VID_IN_3_net),
		  .interrupt({tmpINTERRUPT_0__DEBUG_VID_IN_3_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__DEBUG_VID_IN_3_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__DEBUG_INTERRUPT_4_net;
	wire [0:0] tmpFB_0__DEBUG_INTERRUPT_4_net;
	wire [0:0] tmpIO_0__DEBUG_INTERRUPT_4_net;
	wire [0:0] tmpINTERRUPT_0__DEBUG_INTERRUPT_4_net;
	electrical [0:0] tmpSIOVREF__DEBUG_INTERRUPT_4_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("280e2ccb-6f4f-4330-98b2-ef4809bfe7f9"),
		  ...
		  .input_buffer_sel(2'b00))
		DEBUG_INTERRUPT_4
		 (.oe(tmpOE__DEBUG_INTERRUPT_4_net),
		  .y({Net_4080}),
		  .fb({tmpFB_0__DEBUG_INTERRUPT_4_net[0:0]}),
		  .io({tmpIO_0__DEBUG_INTERRUPT_4_net[0:0]}),
		  .siovref(tmpSIOVREF__DEBUG_INTERRUPT_4_net),
		  .interrupt({tmpINTERRUPT_0__DEBUG_INTERRUPT_4_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__DEBUG_INTERRUPT_4_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__DEBUG_VID_COMPARED_5_net;
	wire [0:0] tmpFB_0__DEBUG_VID_COMPARED_5_net;
	wire [0:0] tmpIO_0__DEBUG_VID_COMPARED_5_net;
	wire [0:0] tmpINTERRUPT_0__DEBUG_VID_COMPARED_5_net;
	electrical [0:0] tmpSIOVREF__DEBUG_VID_COMPARED_5_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("66599b49-8832-4b6b-b887-5634e9889450"),
		  ...
		  .ovt_slew_control(2'b00),
		  .input_buffer_sel(2'b00))
		DEBUG_VID_COMPARED_5
		 (.oe(tmpOE__DEBUG_VID_COMPARED_5_net),
		  .y({Net_2152}),
		  .fb({tmpFB_0__DEBUG_VID_COMPARED_5_net[0:0]}),
		  .io({tmpIO_0__DEBUG_VID_COMPARED_5_net[0:0]}),
		  .siovref(tmpSIOVREF__DEBUG_VID_COMPARED_5_net),
		  .interrupt({tmpINTERRUPT_0__DEBUG_VID_COMPARED_5_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__DEBUG_VID_COMPARED_5_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__DEBUG_1_net;
	wire [0:0] tmpFB_0__DEBUG_1_net;
	wire [0:0] tmpIO_0__DEBUG_1_net;
	wire [0:0] tmpINTERRUPT_0__DEBUG_1_net;
	electrical [0:0] tmpSIOVREF__DEBUG_1_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("7170f142-c110-4fe3-8c78-6f023d48dbe7"),
		  ...
		  .input_buffer_sel(2'b00))
		DEBUG_1
		 (.oe(tmpOE__DEBUG_1_net),
		  .y({Net_6049}),
		  .fb({tmpFB_0__DEBUG_1_net[0:0]}),
		  .io({tmpIO_0__DEBUG_1_net[0:0]}),
		  .siovref(tmpSIOVREF__DEBUG_1_net),
		  .interrupt({tmpINTERRUPT_0__DEBUG_1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__DEBUG_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__DEBUG_6_net;
	wire [0:0] tmpFB_0__DEBUG_6_net;
	wire [0:0] tmpIO_0__DEBUG_6_net;
	wire [0:0] tmpINTERRUPT_0__DEBUG_6_net;
	electrical [0:0] tmpSIOVREF__DEBUG_6_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("d044cc22-f861-47c6-a52d-9bd3e80ffe64"),
		  ...
		  .input_buffer_sel(2'b00))
		DEBUG_6
		 (.oe(tmpOE__DEBUG_6_net),
		  .y({Net_5991}),
		  .fb({tmpFB_0__DEBUG_6_net[0:0]}),
		  .io({tmpIO_0__DEBUG_6_net[0:0]}),
		  .siovref(tmpSIOVREF__DEBUG_6_net),
		  .interrupt({tmpINTERRUPT_0__DEBUG_6_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__DEBUG_6_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
