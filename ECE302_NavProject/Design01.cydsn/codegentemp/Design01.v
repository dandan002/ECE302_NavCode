...
module top ;
    ...
    GlitchFilter_v2_0 GLITCHTIMER (
        .clock(Net_4754),
        .d(Net_2152),
        .q(Net_3790),
        .reset(Net_2127));
    defparam GLITCHTIMER.BypassFilter = 0;
    defparam GLITCHTIMER.GlitchLength = 3;
    defparam GLITCHTIMER.SignalWidth = 1;
